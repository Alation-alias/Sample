...
//                "STARTS : entity.getContentLength=" + entity.getContentLength() + ", partialURL=" + partialURLString);
    ...
    /**
     * This method is specific to post files to server using curl in a specific format that the Java runtime curl accepts
     *
    ...
    public static HttpResponse doPUT(StringEntity entity, String partialURLString) throws Exception {
        HttpResponse response = null;
        HttpClient httpClient = HttpClientBuilder.create().build();
        HttpPut httpPut = new HttpPut(PropHelper.getHelper().getBaseURL() + partialURLString);
        httpPut.setHeader("token", PropHelper.getHelper().getToken());
    ...
    public static HttpResponse doDELETE(String partialURLString) throws Exception {
        HttpResponse response = null;
        HttpClient httpClient = HttpClientBuilder.create().build();
        HttpDelete httpDelete = new HttpDelete(PropHelper.getHelper().getBaseURL() + partialURLString);
        httpDelete.setHeader("token", PropHelper.getHelper().getToken());
   ...
   //code
    public static HttpResponse doVFSPOST(StringEntity entity, String partialURLString) throws Exception {
    			...
    			// Check whether the IGNORE_SSL property is true, if true add self signed SSL to the request
    			if (OverridableProperties.IGNORE_SSL) {
    			 ...
    			 HttpPost httpPost = new HttpPost(PropHelper.getHelper().getBaseURL() + partialURLString);
    			//HttpPost httpPost = new HttpPost(getAlationConfig().getHostName() + partialURLString);
